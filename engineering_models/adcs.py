...
#Calculates environmental torques throughout flight
def environmental_torque_calculation(stage1,stage2,stage3,payload_fairing,positionY,orientation,rocket_height,nosecone_height,total_center_of_mass,drag_array):
    ...
    # Surface Area Illuminated by Sun # f(angle)
    ...
    Area_Illuminated = numpy.linspace(zero_angle_area,stage3.outside_radius**2*math.pi,91) 
...
#Calculates maximum load that would be applied on fins at every time step of the flight
